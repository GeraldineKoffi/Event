...
function Events(){
    ...
    const organisateurIdInputRef=useRef();
   // const imgInputRef= useRef();
    ...
    const handleValidation=async(event)=>{
        ...
        const organisateurId=organisateurIdInputRef.current.value;
    ...
    return(
        ...
        <form className='events' onSubmit={handleValidation}>
         ...
         <input placeholder={localStorage.getItem('id')} name='idorg' type="hidden"  ref={organisateurIdInputRef}/><br/>
